...
class Args(argparse.ArgumentParser):
    ...
    def __init__(self, **overrides):
        ...
        self.add_argument(
            "--trainer_class", default="fastmri.trainer.Trainer", type=str
        )
        ...
        self.add_argument(
            "--copy_data_to_scratch", dest="copy_data_to_scratch", action="store_true"
        )
        self.add_argument(
        ...
        self.add_argument(
            "--resize_type",
            default="crop",
            choices=["none", "crop", "pad", "singlebatch"],
        ...
        self.add_argument(
            ...
            type=bool,
            default=False,
            help="Should you use Grappa for input",
        )
        self.add_argument(
            "--grappa_input_path",
            type=Path,
            default=None,
            help="Path to grappa kernels",
        )
        self.add_argument(
            "--grappa_path", type=Path, default=None, help="Path to grappa kernels"
        )
        self.add_argument(
            "--grappa_target",
            type=bool,
            default=False,
            help="Should you use 2x grappa for the ground truth",
        )
        self.add_argument(
            "--grappa_target_path",
            type=Path,
        ...
        self.add_argument(
            ...
            type=bool,
            default=True,
            help="Should you use Grappa in the kspace model",
        )
        ...
        self.add_argument(
            "--data_path",
            type=Path,
            default="/datasets01_101/fastMRI/112718",
        ...
        self.add_argument(
            ...
            type=int,
            default=None,
            help="Filter input data that has accelerated by the given amount",
        )
        ...
        self.add_argument(
            ...
            nargs="*",
            default=None,
            help="Choices: ['Avanto', 'TrioTim', 'Skyra', 'Aera', 'Biograph_mMR', 'Prisma_fit']",
        )
        ...
        self.add_argument(
            "--method-str",
            help="The main model is build from this string in var_net.var_net",
        )
        self.add_argument(
            "--sens-method-str",
            help="The sensitivty maps model is build from this string in var_net.var_net",
        )
        self.add_argument(
            "--norm",
            choices=("layer", "instance", "group"),
            default="group",
            help="Normalization of the unets in var_net.var_net",
        )
        self.add_argument(
        ...
        self.add_argument(
            ...
            type=int,
            default=3,
            help="Kernel size in convolutions in var_net.var_net",
        )
        self.add_argument(
            "--sqrt-eps",
            type=float,
            default=0,
            help="Number to add before calling .sqrt() in var_net.var_net",
        )
        self.add_argument(
            "--var_net_model",
            type=str,
            default="unet",
            help="The UNet model used in var net",
        )
        ...
        self.add_argument(
            "--mask_type",
            default="equispaced",
            choices=["equispaced", "random", "random_fraction", "magic"],
        ...
        self.add_argument(
            "--debug_phase_direction",
            default=False,
            type=bool,
            help="For debugging only",
        )
        self.add_argument(
            "--add_gibbs_artifacts_augmentation",
            default=False,
            type=bool,
        ...
        self.add_argument(
            "--batch_size", default=20, type=int, help="Per-gpu batch-size"
        )
        self.add_argument(
            "--eval_batch_size",
            default=-1,
        ...
        self.add_argument(
            "--workers", default=8, type=int, help="Data loader worker count per GPU"
        )
        self.add_argument(
            "--pin_memory",
            default=False,
        ...
        self.add_argument(
            ...
            default=False,
            type=bool,
            help="Distributed training flag (set automatically)",
        )
        self.add_argument(
            "--use_barriers",
            default=True,
        ...
        self.add_argument(
            "--apex", default=False, type=bool, help="NVIDIA Apex half-prec training"
        )
        ...
        self.add_argument(
            ...
            default=1,
            type=int,
            help="Start learning rate x times smaller and ramp up",
        )  # Not implemented yet
        ...
        self.add_argument(
            ...
            default=False,
            type=bool,
            help="Output memory diagnostics then quit",
        )
        self.add_argument("--channels", default=2, type=int)

        # UNET Settings
        self.add_argument(
            "--num_chans", type=int, default=128, help="Number of U-Net channels"
        )
        self.add_argument(
            "--res_chans", type=int, default=128, help="Number of U-Net channels"
        )
        self.add_argument(
            "--num_pools", type=int, default=4, help="Number of U-Net pooling layers"
        )
        self.add_argument(
            "--drop_prob", type=float, default=0.0, help="Dropout probability"
        )
        self.add_argument(
            "--num_models",
            type=int,
            default=4,
            help="Number of models for cascaded models",
        )
        self.add_argument("--dilation", type=int, default=1, help="Conv dilation")
        self.add_argument(
            "--num_layers", type=int, default=4, help="Num of conv layers"
        )
        self.add_argument(
            "--groups",
            type=int,
            default=1,
            help="Num of connections between inputs and outputs",
        )
        ...
        self.add_argument(
            "--ssim_loss", type=bool, default=False, help="Use SSIM loss while training"
        )
        self.add_argument(
            "--ssim_l1_coefficient",
            type=float,
        ...
        self.add_argument(
            "--q_loss", type=str, default=None, help="Select a q weighted loss"
        )
        self.add_argument(
            "--loss_denominator_power",
            default=1.0,
            type=float,
        ...
        self.add_argument(
            ...
            default=1,
            type=int,
            help="resnet block expansion factor",
        )
        ...
        self.set_defaults(main_pid=os.getpid(), cwd=os.getcwd())
        ...
        if len(sys.argv) == 2 and "--" not in sys.argv[1] and ".pkl" in sys.argv[1]:
            ...
            if not isinstance(run_config, list):
                if int(os.environ.get("RANK", 0)) == 0:
                    print(
                        f"Found single argument config file: {run_config_file}. Overriding defaults"
                    )
