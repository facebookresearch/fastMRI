...
from mod_fastmri.transforms import batched_central_weight_mask
...
class ModUnetModule(MriModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        weight = batched_central_weight_mask(batch.image)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        return {
            ...
            "val_loss":self.loss_func(output, batch.target),
        }
