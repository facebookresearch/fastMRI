...
from mod_fastmri.mod_unet_module import ModUnetModule
...
def build_args():
    ...
    # module config
    parser = ModUnetModule.add_model_specific_args(parser)
    parser.set_defaults(
    ...
    # parser.add_argument("--strategy", type=str, default=backend, help="Distributed strategy")
    # parser.add_argument("--max_epochs", type=int, default=50, help="Max number of epochs")
    # parser.add_argument("--deterministic", type=bool, default=True, help="Deterministic run")
    # parser.add_argument("--seed", type=int, default=42, help="Random seed")
    # parser.add_argument("--resume_from_checkpoint", type=bool, default=None, help="Resume from checkpoint")
    # parser.add_argument(
    #     "--default_root_dir",
    #     type=str,
