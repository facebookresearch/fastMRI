...
the [fastMRI dataset paper](https://arxiv.org/abs/1811.08839):
...
## [fastMRI Project Papers](LIST_OF_PAPERS.md)

A detailed list of papers with abstracts and bibtex entries can be found [here](LIST_OF_PAPERS.md).
