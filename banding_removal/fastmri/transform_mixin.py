...
class TransformMixin(object):
    def transform_setup(self, args):
        train_mask = mask_factory(
            args.mask_type, args.train_num_low_frequencies, args.train_accelerations
        )
        dev_mask = mask_factory(
            args.mask_type, args.num_low_frequencies, args.accelerations
        )
